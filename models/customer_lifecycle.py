...
class Customer(Base):
    ...
    status = Column(SQLEnum(CustomerStatus, values_callable=lambda obj: [e.value for e in obj]), default=CustomerStatus.LEAD)
...
class PhaseTransition(Base):
    ...
    from_status = Column(SQLEnum(CustomerStatus, values_callable=lambda obj: [e.value for e in obj]), nullable=True)
    to_status = Column(SQLEnum(CustomerStatus, values_callable=lambda obj: [e.value for e in obj]), nullable=False)
